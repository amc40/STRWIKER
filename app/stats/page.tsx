...
const PlayerCard = ({name, gamesPlayed, rarity}: {name: string, gamesPlayed: number, rarity: Rarity}) => {
    return (
        <>
        <div data-tilt data-tilt-glare data-tilt-max-glare="0.8" data-tilt-scale="1.1"
        ...
        ${rarity === Rarity.HOLOGRAPHIC ? "bg-yellow-400" : "bg-slate-300"}`}>
            <div className={"bg-slate-50 rounded-md w-full h-[100px] flex justify-center"}>
                <Image src="/images/Player.png" alt="avatar" width={100} height={100} />
            </div>
            ...
            <div className={"flex flex-wrap"}>
                <StatsColumn>
                    <p><span className={"font-bold pr-1"}>{gamesPlayed}</span>ONE</p>
                    <p><span className={"font-bold pr-1"}>{gamesPlayed}</span>TWO</p>
                </StatsColumn>
            </div>
            <div className={"border-r border-blue-500"}></div>
            <div className={"flex flex-wrap"}>
                <StatsColumn>
                    <p><span className={"font-bold pr-1"}>{gamesPlayed}</span>THR</p>
                    <p><span className={"font-bold pr-1"}>6</span>FOU</p>
                </StatsColumn>
            </div>
            </div>
            </div>
